...
const ReportReceptionAppointment = ({
  receptionAppointment,
  receptionAppointmentList,
}) => {
  if (!receptionAppointment) return null;
  return (
    <div className="mt-4">
      <div className="w-full bg-white p-5 rounded-md">
        <h1 className=" text-2xl border-b-2  mb-2 ">
          Reception Appointment Report
        </h1>
          ...
          <tbody>
            <tr className="border text-lg cursor-pointer select-none hover:bg-sky-100 border-cyan-200  duration-300  ">
              ...
              <td className="px-6 py-4 font-semibold ">
                {receptionAppointmentList.canceled}
              </td>
            </tr>
            <tr className="border text-lg cursor-pointer select-none hover:bg-sky-100 border-cyan-200  duration-300  ">
              <th scope="col" className="bg-cyan-500 text-white px-6 py-4 ">
              ...
              {/* btawe fariza darkawe => parseFloat(mainReportList.total_income).toLocaleString() */}
              <td className="px-6 py-4 font-semibold ">
                {receptionAppointmentList.completed}
              </td>
            </tr>
          </tbody>
        </table>
...
export default ReportReceptionAppointment;
