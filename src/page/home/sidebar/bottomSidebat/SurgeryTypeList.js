...
const SurgeryTypeList = () => {
    ...
    return (
        <div className='w-full'>
            <li className={`${location.pathname === '/surgeryType' && 'bg-blue-500 text-white'} mb-2  cursor-pointer w-full items-center hover:text-white hover:bg-blue-500 duration-100 p-2.5 rounded-lg`}>
