...
const SurgeryTypeList = ({ setShowSildBar }) => {
    ...
    return (
        ...
        <li onClick={() => setShowSildBar(false)} className={`${location.pathname === '/workingtype' && 'bg-blue-500 text-white'} cursor-pointer w-full items-center hover:text-white hover:bg-blue-500 duration-100 p-2.5 rounded-lg`}>
