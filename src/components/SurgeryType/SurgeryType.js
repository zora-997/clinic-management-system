                ...
                <div className='mx-3 mt-10 bg-white overflow-auto rounded-md  p-5  '>
                    <div className='flex justify-between'>
                     ...
                     text-white shadow-sm flex items-center shadow-gray-300 border mb-2 
                      hover:text-cyan-400 border-cyan-300 h-fit 2xl:text-xl p-1 px-9 rounded-md bg-cyan-500 hover:bg-transparent duration-200`}>Create working type</button>
                    </div>
                    <table className="bg-white overflow-hidden text-sm 2xl:text-lg shadow-sm text-left text-gray-500 w-full">
