  ...
  return (
    <Modal>
      <div className="flex flex-col  justify-center items-center w-5/6">
        <button
          className="text-gray-700  place-self-end text-xl    "
        ...
        <div
          className={` flex flex-col p-5  w-full bg-white h-[400px] rounded-md  `}
        >
            ...
            <div className="mt-5 flex justify-between">
              <div className="relative w-[30%]">
                <div className="flex flex-col w-full border-b rounded-md  absolute">
                  ...
                  <input
                    ...
                    }  w-full  text-sm focus:ring-1 focus:ring-sky-500 pl-2 focus:outline-none border border-gray-300 p-2 rounded shadow-sm shadow-black/10 `}
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col w-[30%]">
                ...
                <input
                  ...
                  } focus:outline-none border pl-2 p-2 w-full  rounded shadow-sm shadow-black/10`}
                />
              </div>
                ...
                <button
                  ...
                  className={` ${
                    surgery_type_price
                      ...
                      : "bg-green-200"
                  } w-32  shadow-sm  shadow-gray-300 border text-white border-green-300  p-1.5  rounded-md  `}
                >
                  Upadte
                </button>
              </div>
