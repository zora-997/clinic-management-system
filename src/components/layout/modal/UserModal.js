                ...
                <form onSubmit={(e) => { updateUserHandler(e); onClose(false); }} className=' bg-white rounded-md 2xl:w-[700px] w-[500px]   flex flex-col  p-5'>
                    ...
                    <div className='w-full '>
                        ...
                        <div className='flex gap-3 w-full justify-between'>
                            <button onClick={(e) => { updateUserHandler(e); onClose(false); }} className='border rounded-md bg-cyan-500 hover:bg-cyan-400 text-white px-8 p-1.5 my-2'>Update</button>
                            <button onClick={() => { deleteUser(admin_id); onClose(false); }} className='border rounded-md bg-red-500 hover:bg-red-400 text-white   px-8 p-1.5 my-2'>Delete</button>
