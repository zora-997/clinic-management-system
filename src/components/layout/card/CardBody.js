        ...
        <div className=' mx-2 xl:flex  xl:justify-between grid  sm:grid-cols-2 gap-3 xl:gap-5   '>
            ...
            <div style={{ backgroundColor: '#0171FE' }}
                ...
                <div className='flex flex-col  pt-3 pl-2 g transition-colors duration-500 ease-in-out'>
                    <span style={{ color: '#A3D5F9' }} className='text-sm 2xl:text-lg '>Active Doctor</span>
                    <span style={{ color: '#DFF4FD' }} className='text-xl pb-3 relative 2xl:text-3xl '>{doctorList.length}</span>
                </div>

                {/** icon kall */}
                <div>
                    {/* <FaUsers style={{ color: '#4196FF' }} size={83} className="absolute -right-1 top-12" /> */}
                    <img src={medicalteam2} alt="no doctor" className="absolute w-24 2xl:w-32 2xl:-right-2 -right-1  top-11" />
            ...
            <div style={{ backgroundColor: '#04D5C7' }}
                ...
                <div className='flex flex-col  pt-3 pl-2  '>
                    <span style={{ color: '#ACFFFB' }} className='text-sm 2xl:text-lg '>Active Patient</span>
                    <span style={{ color: '#EBFFFF' }} className='text-xl pb-3 relative 2xl:text-3xl'>{sickList.length}</span>
                </div>

                {/** icon kall */}
                <div>
                    <FaUser style={{ color: '#2CDED2' }} size={70} className="absolute 2xl:scale-125 top-12 2xl:top-16 -right-2 2xl:-right-1" />
            ...
            <div style={{ backgroundColor: '#9284F7' }}
                ...
                <div className='flex flex-col  pt-3 pl-2 g transition-colors duration-500 ease-in-out'>
                    <span style={{ color: '#DBD3FF' }} className='text-sm 2xl:text-lg'>Working</span>
                    <span style={{ color: '#F8F6FF' }} className='text-xl pb-3 relative 2xl:text-3xl '>{sickSurgery.length}</span>
                </div>

                {/** icon kall */}
                <div>
                    <BsFillHeartPulseFill style={{ color: '#A398FB' }} size={87} className="absolute 2xl:scale-125 top-10 2xl:top-14 -right-2 2xl:-right-0 " />
                    <span className='absolute rounded-full w-28 2xl:w-32 h-28 2xl:h-32 bg-white/5 -left-10  -top-20 '></span>
                    <span className='absolute rounded-full w-32 2xl:w-36 h-32 2xl:h-36 bg-white/10 -left-10  -top-20 '></span>
                </div>
            </div>
            ...
            <div style={{ backgroundColor: '#FF996C' }}
                ...
                <div className='flex flex-col  pt-3 pl-2 g transition-colors duration-500 ease-in-out'>
                    <span style={{ color: '#FFDFD1' }} className='text-sm 2xl:text-lg'>Today Appointment</span>
                    <span style={{ color: '#F8F6FF' }} className='text-xl pb-3 relative 2xl:text-3xl'>{appointmentList.length}</span>
                </div>

                {/** icon kall */}
                <div>
                    {/* <TbReportAnalytics style={{ color: '#FFAC89' }} size={87} className="absolute top-12 -right-3" /> */}
                    <img src={reportkall2} alt="no doctor" className="absolute w-20 2xl:w-24 top-12 2xl:top-16  -right-3" />
                    <span className='absolute rounded-full w-28 2xl:w-32 h-28 2xl:h-32 bg-white/10 -left-10  -top-20 '></span>
                    <span className='absolute rounded-full w-32 2xl:w-36 h-32 2xl:h-36 bg-white/20 -left-10  -top-20 '></span>
                </div>
            </div>
