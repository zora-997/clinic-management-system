        ...
        <div className='flex justify-end mt-16'>
            <div className='grid gap-y-10 place-items-start grid-cols-3 w-3/4 mr-20 '>
                ...
                <div className="w-[240px] p-3 bg-white group border-t-8 border-t-cyan-300 hover:border border duration-300   hover:border-cyan-300  rounded-lg shadow ">
                    <AiOutlineMoneyCollect className="w-10 h-10  group-hover:text-cyan-400 duration-300 text-gray-500 " />
                ...
                <div className="relative w-[240px]  p-3 overflow-hidden bg-white group border-t-8 border-t-green-300 hover:border border duration-300   hover:border-green-300  rounded-lg shadow ">
                    <ReportDoctor showDoctor={showDoctor} setShowDoctor={setShowDoctor} />
                    <div className='flex items-start justify-between'>
                        <MdAttachMoney className="w-10 h-10 group-hover:text-green-400 duration-300 text-gray-500 " />
                ...
                <div className="relative w-[240px] p-3 overflow-hidden bg-white group border-t-8 border-t-purple-300 hover:border border duration-300   hover:border-purple-300  rounded-lg shadow ">
                    ...
                    <div className='flex items-start justify-between'>
                        ...
                        <SiExpensify className="w-10 h-10 group-hover:text-purple-400 duration-300 text-gray-500 " />
                ...
                {/* ******************************* Loan ***************************************** */}
                <div className="relative w-[240px] p-3 overflow-hidden bg-white group border-t-8 border-t-red-300 hover:border border duration-300   hover:border-red-300  rounded-lg shadow ">
                    <div className='flex items-start justify-between'>
                        {/* <svg className="w-10 h-10 mb-2 group-hover:text-purple-400 duration-300 text-gray-500 " aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg> */}
                        <TbZoomMoney className="w-10 h-10 group-hover:text-red-400 duration-300 text-gray-500 " />
                ...
                <div className="relative w-[240px] p-3 overflow-hidden bg-white group border-t-8 border-t-orange-300 hover:border border duration-300   hover:border-orange-300  rounded-lg shadow ">
                    {/* <svg className="w-10 h-10 mb-2 group-hover:text-purple-400 duration-300 text-gray-500 " aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg> */}
                    <HiOutlineAnnotation className="w-10 h-10 group-hover:text-orange-400 duration-300 text-gray-500 " />
                ...
                <div className="relative w-[240px] p-3 overflow-hidden bg-white group border-t-8 border-t-yellow-300 hover:border border duration-300   hover:border-yellow-300  rounded-lg shadow ">
                    <div className='flex items-start justify-between'>
                        {/* <svg className="w-10 h-10 mb-2 group-hover:text-purple-400 duration-300 text-gray-500 " aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg> */}
                        <BiUserPin className="w-10 h-10  group-hover:text-yellow-400 duration-300 text-gray-500 " />
